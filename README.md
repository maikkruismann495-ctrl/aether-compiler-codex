...
For the complete language specification, grammar, and deep-dive tutorials, read the [**Aether Handbook**](https://github.com/torbenn211/aether-compiler/blob/main/book.md).
